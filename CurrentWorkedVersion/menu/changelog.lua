...
function changelog:draw()
	...
	love.graphics.print('- Wave length now increases with', (love.graphics.getWidth()/2 - 580), 390)
	love.graphics.print('  each wave.', (love.graphics.getWidth()/2 - 580), 415)
	love.graphics.print('- Power-ups now spawn based on score.', (love.graphics.getWidth()/2 - 580), 440)
	love.graphics.print('- Power-ups can now spawn more than', (love.graphics.getWidth()/2 - 580), 465)
	love.graphics.print('  once in a wave.', (love.graphics.getWidth()/2 - 580), 490)
	love.graphics.print('- Added "1up" power-up - gives', (love.graphics.getWidth()/2 - 580), 515)
	love.graphics.print('  you an extra life.', (love.graphics.getWidth()/2 - 580), 540)
	love.graphics.print('- Added a mysterious new power-up,', (love.graphics.getWidth()/2 - 580), 565)
	love.graphics.print('  marked with a question mark.', (love.graphics.getWidth()/2 - 580), 590)
	love.graphics.print('- Continue screen now appears if', (love.graphics.getWidth()/2 - 580), 615)
	love.graphics.print('  you have an extra life.', (love.graphics.getWidth()/2 - 580), 640)
	love.graphics.print('- A shotgun now replaces the pistol', (love.graphics.getWidth()/2 - 580), 665)
	love.graphics.print('  as the default weapon past wave 15.', (love.graphics.getWidth()/2 - 580), 690)
