...
function start:draw()
	...
	love.graphics.print('© 2016 PIQUANT INTERACTIVE', (love.graphics.getWidth( )/2-self.font2:getWidth("© 2016 PIQUANT INTERACTIVE")/2), (love.graphics.getHeight( )/2 - fpsfont:getHeight( "PUSH START BUTTON" )/2 + 190))
