...
function credits:draw()
	...
	love.graphics.print("PROGRAMER", (love.graphics.getWidth( )/2-start.font2:getWidth("PROGRAMER")/2), self.slider + 450)
	...
	love.graphics.print("PRESS START 2P FONT", (love.graphics.getWidth( )/2-start.font2:getWidth("PRESS START 2P FONT")/2), self.slider + 900)
	love.graphics.print("CODEMAN38", (love.graphics.getWidth( )/2-start.font2:getWidth("CODEMAN38")/2), self.slider + 950)
	love.graphics.print("HUMP LIBRARY", (love.graphics.getWidth( )/2-start.font2:getWidth("HUMP LIBRARY")/2), self.slider + 1050)
	love.graphics.print("MATTHIAS RICHTER", (love.graphics.getWidth( )/2-start.font2:getWidth("MATTHIAS RICHTER")/2), self.slider + 1100)
	love.graphics.print("HARDONCOLLIDER LIBRARY", (love.graphics.getWidth( )/2-start.font2:getWidth("HARDONCOLLIDER LIBRARY")/2), self.slider + 1200)
	love.graphics.print("MATTHIAS RICHTER", (love.graphics.getWidth( )/2-start.font2:getWidth("MATTHIAS RICHTER")/2), self.slider + 1250)
	love.graphics.print("SPECIAL THANKS", (love.graphics.getWidth( )/2-start.font2:getWidth("SPECIAL THANKS")/2), self.slider + 1350)
